...
import { getNamkeens } from '../../API/namkeens.api.js'
import { setNamkeensData } from '../../Redux/namkeens.redux.js'
...
function Namkeen() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      if (result?.data) {
        dispatch(setNamkeensData(result.data))
  ...
  useEffect(() => {
    document.title = page > 1
      ? `Sugar Orbit | Namkeens - Page ${page}`
      : `Sugar Orbit | Namkeens`
  }, [page])
        ...
        <section className="category-main-container row">
          <div className="div-80">
            <section className="category-header-section">
              <h1>Namkeens</h1>
              <div className="para">
                <p>At Sugar Orbit, our namkeens are crafted with the perfect blend of tradition and taste, using high-quality ingredients and authentic spice mixes. Each crunchy bite delivers bold flavors, balanced seasoning, and a satisfying crispness that keeps you coming back for more. 🌶️✨</p>
              </div>
